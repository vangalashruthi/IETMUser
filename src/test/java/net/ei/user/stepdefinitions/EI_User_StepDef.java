...
import net.user.utility.OpenBrowser;
...
public class EI_User_StepDef {
	...
	{
		eiuserpage.clickWarningAndSafetyContent();
	}
	...
	public void user_is_to_click_the_enter_ietm1() {
